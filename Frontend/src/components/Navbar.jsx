...
function Navbar() {
  ...
  const [theme,setTheme]=useState(localStorage.getItem('theme')?localStorage.getItem('theme'):'light')  /* DARK MODE */
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl cursor-pointer font-bold">Novelty</a>
  </div>
